import type { AddXML, AvatarXML, DirectionOffsetXML, EffectFramePartItemXML, EffectFramePartXML, EffectFrameXML, IAssetAnimation, IAssetAnimationAdd, IAssetAnimationAvatar, IAssetAnimationDirection, IAssetAnimationFrame, IAssetAnimationFramePart, IAssetAnimationFramePartItem, IAssetAnimationOverride, IAssetAnimationRemove, IAssetAnimationShadow, IAssetAnimationSprite, IAssetAnimationSpriteDirection, IAssetData, OverrideXML, RemoveXML, ShadowXML, SpriteXML } from '../../core';
import { EffectAnimationXML } from '../../core';
